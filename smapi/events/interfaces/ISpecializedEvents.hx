...
import cs.system.EventHandler_1;
 ...
 extern interface ISpecializedEvents
 {
     ...
     @:event extern var LoadStageChanged: EventHandler_1<LoadStageChangedEventArgs>;
     ...
     @:event extern var UnvalidatedUpdateTicking: EventHandler_1<UnvalidatedUpdateTickingEventArgs> ;
     ...
     @:event extern var UnvalidatedUpdateTicked: EventHandler_1<UnvalidatedUpdateTickedEventArgs> ;
 }